...
/**
 * Desktop implementation of WebSocketClient
 *
 * Note: This is a mock implementation for Phase 1.
 * Real implementation using Ktor WebSocket will be done in Phase 4.
 */
actual class WebSocketClient {
    ...
    actual suspend fun connect(serverUrl: String): Result<Unit> {
        // Mock implementation - Phase 4 will use actual Ktor WebSocket
     ...
     *
     * MOCK: Phase 4 will implement actual disconnection
     */
    ...
    actual suspend fun sendHeartRateData(data: HeartRateData): Result<Unit> {
        // Mock implementation - Phase 4 will use actual WebSocket send
        return Result.success(Unit)
    }
