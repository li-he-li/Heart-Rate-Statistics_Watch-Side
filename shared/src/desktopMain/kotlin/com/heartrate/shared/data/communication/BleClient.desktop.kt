...
/**
 * Desktop implementation of BleClient
 *
 * Note: This is a mock implementation for Phase 1.
 * Real implementation using SimpleBLE or platform-specific BLE will be done in Phase 4.
 */
actual class BleClient {
    ...
    actual suspend fun startAdvertising(serviceName: String): Result<Unit> {
        // Mock implementation - Phase 4 will use actual SimpleBLE or native APIs
     ...
     *
     * MOCK: Phase 4 will implement actual stopping
     */
    ...
    actual suspend fun sendHeartRateData(data: HeartRateData): Result<Unit> {
        // Mock implementation - Phase 4 will use actual BLE send
        return Result.success(Unit)
    }
