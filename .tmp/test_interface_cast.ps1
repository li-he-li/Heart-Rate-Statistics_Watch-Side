...
[void][Windows.Devices.Bluetooth.GenericAttributeProfile.IGattDeviceService3,Windows.Devices.Bluetooth,ContentType=WindowsRuntime]
...
try {
  $iface=[Windows.Devices.Bluetooth.GenericAttributeProfile.IGattDeviceService3]$service
  'CAST_OK'
  $op=$iface.GetCharacteristicsForUuidAsync($cu,[Windows.Devices.Bluetooth.BluetoothCacheMode]::Uncached)
