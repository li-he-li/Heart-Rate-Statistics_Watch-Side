...
class WearMonitoringForegroundService : Service(), KoinComponent {
    ...
    override fun onCreate() {
        ...
        startForeground(NOTIFICATION_ID, buildNotification(status = "Starting", heartRate = null))
    }
    ...
    companion object {
        ...
        fun stop(context: Context) {
            context.stopService(Intent(context, WearMonitoringForegroundService::class.java))
        }
    }
}
